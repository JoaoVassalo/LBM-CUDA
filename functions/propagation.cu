                            ...
                            float *rho_out, float *ux_out, float *uy_out, float *mxx_out, float *mxy_out, float *myy_out)
{
   ...
   { // Sudoeste
      ...
      corner(I_s, O_s, x, y, rho_in, ux_in, uy_in, mxx_in, mxy_in, myy_in,
             rho_out);
   ...
   { // Noroeste
      ...
      north(size, I_s, O_s, x, y, rho_in, ux_in, uy_in, mxx_in, mxy_in, myy_in,
            rho_out, mxy_out);
   ...
   { // Sul
      ...
      wall(I_s, O_s, x, y, rho_in, ux_in, uy_in, mxx_in, mxy_in, myy_in,
           rho_out, mxy_out);
   ...
   calc_density(x, y, rho_in, ux_in, uy_in, mxx_in, mxy_in, myy_in,
                rho_out);

   calc_velocity(x, y, rho_in, ux_in, uy_in, mxx_in, mxy_in, myy_in,
                 rho_out, ux_out, uy_out);

   calc_momentum(x, y, rho_in, ux_in, uy_in, mxx_in, mxy_in, myy_in,
